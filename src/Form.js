...
export default class Form extends Component {
    ...
    render() {
        return (
            <div style ={{textAlign:"left", padding:"40px", lineHeight:"40px"}}>
...
<br/>
                <div>
                    <p><span style ={{color:"green", fontWeight:"bold"}}>Email</span>: {this.state.email}</p>
                    <p><span style ={{color:"green", fontWeight:"bold"}}>Full Name</span>: {this.state.name}</p>
                    <p><span style ={{color:"green", fontWeight:"bold"}}>Address</span>: {this.state.address}</p>
                    <p><span style ={{color:"green", fontWeight:"bold"}}>City</span>: {this.state.city}</p>
                    <p><span style ={{color:"green", fontWeight:"bold"}}>Province</span>: {this.state.province}</p>
                    <p><span style ={{color:"green", fontWeight:"bold"}}>Postal Code</span>: {this.state.postalCode}</p>
                </div>
            </div>
        )
    }
